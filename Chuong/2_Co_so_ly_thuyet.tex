...
Ở chiều ngược lại, robot omni, mecanum hoặc swerve-drive phù hợp với những môi trường phẳng, sạch và cần độ cơ động cao, chẳng hạn thi đấu robot, kho hàng, nhà máy hoặc phòng thí nghiệm. Các cơ cấu này có thể thay đổi hướng vận tốc trên mặt phẳng mà không nhất thiết phải quay toàn bộ thân robot trước. Do đó, Metric H được dùng như một mô hình đối chứng cho nhóm robot có chi phí quay thân được xem là không đáng kể trong phạm vi mô hình.
...
\hline
Robot dùng bánh omni & Có các con lăn phụ giúp robot tạo chuyển động toàn hướng trên mặt phẳng. & Metric H hoặc gần Metric H. \\
\hline
Robot dùng bánh mecanum & Phối hợp vận tốc các bánh có con lăn nghiêng để đi tiến, ngang, chéo hoặc quay. & Metric H ở mức lập kế hoạch năng lượng; vẫn có tổn hao cơ học riêng. \\
\hline
Robot swerve-drive & Mỗi module bánh có thể xoay hướng độc lập; robot đổi hướng di chuyển bằng cách xoay module bánh thay vì quay toàn bộ thân. & Gần Metric H; nếu cần chi tiết hơn có thể thêm chi phí xoay module. \\
\hline
\end{tabular}
...
Bảng trên không nhằm khẳng định một cấu trúc truyền động luôn tốt hơn cấu trúc khác. Mỗi loại robot được tối ưu cho một nhóm môi trường và nhiệm vụ khác nhau. Đối với đồ án này, bối cảnh chính là robot bao phủ trong môi trường có địa hình khó, ràng buộc năng lượng và yêu cầu quay về căn cứ. Vì vậy, việc chọn mô hình vi sai tương đương có chi phí quay làm mô hình chính là phù hợp với lớp ứng dụng mục tiêu. Metric H vẫn có giá trị vì nó cung cấp một đối chứng cho nhóm robot toàn hướng hoặc cho các trường hợp chi phí quay được xem là không đáng kể trong phạm vi mô hình.
...
Từ các phân tích trên, mô hình trong đồ án được xây dựng theo hướng tách rõ hai giả định. Mô hình có chi phí quay đại diện cho lớp robot có hướng thân rõ ràng, phù hợp với robot vi sai, skid-steer và bánh xích trong các nhiệm vụ địa hình hoặc rủi ro. Metric H đại diện cho lớp robot toàn hướng hoặc các trường hợp chi phí quay đủ nhỏ để có thể bỏ qua trong phạm vi lập kế hoạch. Cách tách này giúp hệ thống mô phỏng không bị gắn cứng với một loại robot cụ thể, đồng thời vẫn giữ được tính đơn giản cần thiết để phân tích thuật toán và so sánh thực nghiệm.
...
Metric H không được xây dựng nhằm thay thế mô hình có chi phí quay. Nó biểu diễn một giả định khác về robot, phù hợp hơn với các hệ thống có khả năng đổi hướng linh hoạt hoặc khi chi phí quay thân được xem là không đáng kể trong phạm vi mô hình. Ngược lại, trong bối cảnh chính của đồ án là robot mặt đất dùng cho dò mìn, rà soát hoặc khảo sát địa hình khó, mô hình có chi phí quay là mô hình chính vì các nền tảng vi sai, skid-steer và bánh xích đều có hướng thân rõ ràng và phải trả chi phí khi đổi hướng.
...
Chương này cũng đã trình bày cách hiểu trọng số địa hình như chi phí năng lượng tương đối đã chuẩn hóa, mô hình năng lượng di chuyển, năng lượng quay, mối liên hệ giữa năng lượng quay và khoảng cách hiệu dụng $L$ sau khi quy đổi về mô hình vi sai hai bánh tương đương, điều kiện quay về căn cứ, tập ô an toàn trong môi trường có vật cản động và vai trò của Metric H như một mô hình đối chứng. Dựa trên các cơ sở này, Chương 3 sẽ trình bày phương pháp đề xuất và cách hiện thực hóa các thành phần lý thuyết thành một hệ thống mô phỏng cụ thể.
