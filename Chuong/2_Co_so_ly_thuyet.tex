...
Cách phân loại trên phù hợp với nhiều nền tảng robot thực tế. TIAGo Base của PAL Robotics là một ví dụ về nền tảng dùng hai bánh chủ động và bốn bánh tự do, trong khi TIAGo OMNI Base là nền tảng di chuyển toàn hướng \cite{palroboticsTiagoBase2026,palroboticsOmniBase2026}. Clearpath Husky A300 là ví dụ điển hình của robot mặt đất bốn bánh dùng cho môi trường ngoài trời và địa hình khó \cite{clearpathHuskyA3002026}. Các module swerve thương mại như MAXSwerve cũng cho thấy swerve-drive là một cấu trúc truyền động thực tế, thường được dùng khi cần khả năng đổi hướng linh hoạt \cite{revroboticsMaxSwerve2026}. Các ví dụ này không nhằm biến đồ án thành một khảo sát cơ khí robot, mà nhằm làm rõ rằng hai mô hình năng lượng của đồ án có thể ánh xạ tới nhiều cấu trúc truyền động phổ biến.
...
Bảng trên không nhằm khẳng định một cấu trúc truyền động luôn tốt hơn cấu trúc khác. Mỗi loại robot được tối ưu cho một nhóm môi trường và nhiệm vụ khác nhau. Đối với đồ án này, bối cảnh chính là robot bao phủ trong môi trường có địa hình khó, ràng buộc năng lượng và yêu cầu quay về căn cứ. Vì vậy, việc chọn mô hình vi sai tương đương có chi phí quay làm mô hình chính là phù hợp với lớp ứng dụng mục tiêu. Mô hình toàn hướng lý tưởng vẫn có giá trị vì nó cung cấp một đối chứng cho nhóm robot toàn hướng hoặc cho các trường hợp chi phí quay được bỏ qua ở mức lập kế hoạch.
...
Từ các phân tích trên, mô hình trong đồ án được xây dựng theo hướng tách rõ hai giả định. Mô hình có chi phí quay đại diện cho lớp robot có hướng thân rõ ràng, phù hợp với robot vi sai, skid-steer và bánh xích trong các nhiệm vụ địa hình hoặc rủi ro. Mô hình toàn hướng lý tưởng đại diện cho lớp robot toàn hướng hoặc các trường hợp chi phí quay đủ nhỏ để có thể bỏ qua trong phạm vi lập kế hoạch. Cách tách này giúp hệ thống mô phỏng không bị gắn cứng với một loại robot cụ thể, đồng thời vẫn giữ được tính đơn giản cần thiết để phân tích thuật toán và so sánh thực nghiệm.
...
\]
Mô hình toàn hướng lý tưởng không được xây dựng nhằm thay thế mô hình có chi phí quay. Nó biểu diễn một giả định khác về robot, phù hợp hơn với các hệ thống có khả năng đổi hướng linh hoạt hoặc khi chi phí quay thân nhỏ không đáng kể trong phạm vi mô hình lập kế hoạch. Ngược lại, trong bối cảnh chính của đồ án là robot mặt đất dùng cho dò mìn, rà soát hoặc khảo sát địa hình khó, mô hình có chi phí quay là mô hình chính vì các nền tảng vi sai, skid-steer và bánh xích đều có hướng thân rõ ràng và phải trả chi phí khi đổi hướng.

Việc so sánh hai mô hình không nhằm kết luận rằng robot toàn hướng luôn tốt hơn hoặc robot vi sai luôn tốt hơn. Nó chỉ cho phép đánh giá tác động của giả định cơ khí tới hành vi bao phủ. Trong cùng một bản đồ và cùng một chiến lược nhiệm vụ, nếu hai mô hình cho kết quả khác nhau về số bước, số lần quay về căn cứ, số bước đi lại hoặc năng lượng tiêu thụ, sự khác biệt đó cho thấy chi phí quay không chỉ là phần cộng thêm sau khi có đường đi, mà có thể ảnh hưởng trực tiếp tới quyết định lập kế hoạch.
