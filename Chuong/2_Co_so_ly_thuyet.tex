...
Với định hướng robot dò mìn hoặc rà soát vật nguy hiểm, việc bao phủ toàn bộ vùng hợp lệ giúp giảm nguy cơ bỏ sót vùng cần kiểm tra. Trong phạm vi đồ án, một ô được bao phủ được hiểu là ô đã được robot xử lý trong mô hình mô phỏng thuật toán. Kết luận này phục vụ đánh giá chiến lược lập kế hoạch, không được đồng nhất với kết luận ngoài thực địa rằng vùng đó đã được cảm biến dò mìn xác minh an toàn tuyệt đối.
