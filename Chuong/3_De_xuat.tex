...
Hệ thống hoạt động theo vòng lặp nhiệm vụ. Ở mỗi bước, robot không chỉ chọn mục tiêu gần nhất, mà còn xét chi phí đường đi, năng lượng còn lại, đường quay về căn cứ và trạng thái an toàn của môi trường. Nhờ đó, chương trình mô phỏng được các ràng buộc chính của một nhiệm vụ dài: phải bao phủ thêm ô mới, nhưng vẫn giữ khả năng quay về và xử lý vật cản động.
...
H=\{N,E,S,W\}.
\]
Cách rời rạc hóa bốn hướng được chọn vì khớp với bản đồ lưới vuông và giữ số trạng thái ở mức kiểm soát được. Các mô hình nhiều hướng hơn có thể được xây dựng bằng cách mở rộng tập $H$ và bổ sung chi phí chuyển hướng tương ứng, nhưng khi đó bộ lập kế hoạch phải xử lý nhiều trạng thái hơn.
...
Những chuyển trạng thái này là chính sách nhiệm vụ của chương trình mô phỏng, chưa phải bộ điều khiển robot thực địa đầy đủ. Vai trò của chúng là làm cho robot có hành vi nhất quán khi gặp các ràng buộc về năng lượng, vật cản động và điều kiện quay về.
